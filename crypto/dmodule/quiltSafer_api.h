...
/* Falcon 공개키/개인키/서명 최대 크기 */
#define NMC_MAX_FALCON_PUBKEY_SIZE 1793
#define NMC_MAX_FALCON_PRIKEY_SIZE 2305
#define NMC_MAX_FALCON_SIG_SIZE 1280
#define NMC_FALCON_NONCE_SIZE 40
...
#define NMC_MAX_LABEL_BYTE_LEN 256
	...
	***********************************************************************/
	enum NSCE_ATTRIBUTE_TYPE
	{
		...
		/* Falcon의 NIST security level을 나타내는 NT_ATTRIBUTE */
		NAT_FALCON_SECURITY_LEVEL,
	};
	...
	enum NSCE_FALCON_SECURITY_LEVEL
	{
		NOP_FALCON_512 = 9,
		NOP_FALCON_1024 = 10,
	};
